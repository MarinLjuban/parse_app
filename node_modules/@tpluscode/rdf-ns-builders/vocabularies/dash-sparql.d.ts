...
export declare const strict: Record<keyof Dash_sparql, NamedNode<string>> & ((property?: TemplateStringsArray | keyof Dash_sparql | undefined) => NamedNode<string>) & Dash_sparql;
